...
ActiveRecord::Schema.define(version: 20161215011753) do
  ...
  add_index "comments", ["opinion_id"], name: "index_comments_on_opinion_id", using: :btree
  ...
  add_index "suggestions", ["annotation_id"], name: "index_suggestions_on_annotation_id", using: :btree
