...
Vote.create(user_id: user4.id, votable_id: annotation1.id, votable_type: "Annotation", status: 1)
Vote.create(user_id: user4.id, votable_id: annotation5.id, votable_type: "Annotation", status: -1)
Vote.create(user_id: user4.id, votable_id: annotation6.id, votable_type: "Annotation", status: 1)
Vote.create(user_id: user4.id, votable_id: annotation13.id, votable_type: "Annotation", status: 1)
Vote.create(user_id: user4.id, votable_id: suggestion6.id, votable_type: "Suggestion", status: 1)
Vote.create(user_id: user4.id, votable_id: suggestion11.id, votable_type: "Suggestion", status: -1)
Vote.create(user_id: user4.id, votable_id: suggestion12.id, votable_type: "Suggestion", status: 1)
Vote.create(user_id: user4.id, votable_id: suggestion14.id, votable_type: "Suggestion", status: -1)
Vote.create(user_id: user4.id, votable_id: comment1.id, votable_type: "Comment", status: -1)
Vote.create(user_id: user4.id, votable_id: comment2.id, votable_type: "Comment", status: 1)
Vote.create(user_id: user4.id, votable_id: comment8.id, votable_type: "Comment", status: 1)
Vote.create(user_id: user4.id, votable_id: comment11.id, votable_type: "Comment", status: -1)
