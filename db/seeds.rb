...
opinion1 = Opinion.create(case: "Marbury v. Madison", citation: "5 U.S. 137", body: body, date: Date.new(1803, 2, 24), transcriber_id: user1.id, judge_id: 121, court_id: 1)
opinion2 = Opinion.create(case: "Loving v. Virginia", citation: "388 U.S. 1", body: body, date: Date.new(1967, 6, 12), transcriber_id: user1.id, judge_id: 121, court_id: 1)
opinion3 = Opinion.create(case: "Gore v. Bush", citation: "531 U.S. 98", body: body, date: Date.new(2000, 12, 12), transcriber_id: user2.id, judge_id: 121, court_id: 1)
opinion4 = Opinion.create(case: "Hambi v. Rumsfeld", citation: "542 U.S. 507", body: body, date: Date.new(2004, 6, 28), transcriber_id: user3.id, judge_id: 121, court_id: 1)
opinion5 = Opinion.create(case: "U.S. v. Korematsu", citation: "323 U.S. 214", body: body, date: Date.new(1844, 12, 18), transcriber_id: user5.id, judge_id: 121, court_id: 1)
opinion6 = Opinion.create(case: "Brown v. Board of Education", citation: "347 U.S. 483", body: body, date: Date.new(1954, 5, 17), transcriber_id: user5.id, judge_id: 121, court_id: 1)
